...
endop
	...
	<instancesModules>
		<moduleInstance id="1" name="control/MidiNoteIn" xPos="9" yPos="14">
			<inputs>
		...
		<moduleInstance id="2" name="maths/ControlMultiply" xPos="166" yPos="15">
			<inputs>
				<val description="First control signal" id="0" value="1.0"/>
				<val description="Second control signal" id="1" value="1.0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="3" name="modulators/SineLfo" xPos="132" yPos="205">
			<inputs>
		...
		<moduleInstance id="4" name="modulators/AdsrLinMidi" xPos="14" yPos="211">
			<inputs>
				<val description="Amplitude scale factor" id="0" value="0.013"/>
				<val description="Attack time in seconds" id="1" value="10.0"/>
		...
		<moduleInstance id="5" name="maths/ControlAdd" xPos="159" yPos="134">
			<inputs>
				<val description="First control signal" id="0" value="0"/>
				<val description="Second control signal" id="1" value="1.0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="6" name="maths/ControlMultiply" xPos="321" yPos="15">
			<inputs>
				<val description="First control signal" id="0" value="1.0"/>
				<val description="Second control signal" id="1" value="1.007"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="7" name="maths/ControlMultiply" xPos="322" yPos="73">
			<inputs>
				<val description="First control signal" id="0" value="1.0"/>
				<val description="Second control signal" id="1" value="0.994"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="8" name="maths/ControlMultiply" xPos="321" yPos="131">
			<inputs>
				<val description="First control signal" id="0" value="1.0"/>
				<val description="Second control signal" id="1" value="0.5"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="9" name="maths/ControlMultiply" xPos="322" yPos="225">
			<inputs>
				<val description="First control signal" id="0" value="1.0"/>
				<val description="Second control signal" id="1" value="2.0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="10" name="sound sources/SawVco" xPos="471" yPos="15">
			<inputs>
		...
		<moduleInstance id="11" name="sound sources/SawVco" xPos="470" yPos="79">
			<inputs>
				<val description="Frequency of oscillator" id="0" value="0"/>
				<val description="Shape of wave, sawtooth/triangle/ramp" id="1" value="0.001"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="12" name="sound sources/SquareVco" xPos="471" yPos="139">
			<inputs>
				<val description="Frequency of oscillator" id="0" value="0"/>
				<val description="Pulse width of square wave" id="1" value="0.5"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="13" name="amps mixers/Mixer4" xPos="601" yPos="21">
			<inputs>
				<val description="First audio rate signal" id="0" value="0"/>
				<val description="Amplitude multiplicator for in1" id="1" value="0.8"/>
				<val description="Second audio rate signal" id="2" value="0"/>
				<val description="Amplitude multiplicator for in2" id="3" value="0.8"/>
				...
				<val description="Amplitude multiplicator for in4" id="7" value="0.6"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="14" name="filters/MoogVcf" xPos="609" yPos="206">
			<inputs>
				...
				<val description="Filter resonance (self-resonates at 1)" id="2" value="0.1"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="15" name="maths/ControlAdd" xPos="470" yPos="224">
			<inputs>
				<val description="First control signal" id="0" value="0"/>
				<val description="Second control signal" id="1" value="0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="16" name="amps mixers/Amp" xPos="615" yPos="299">
			<inputs>
				<val description="Audio signal" id="0" value="0"/>
				<val description="Gain" id="1" value="0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="17" name="input output/PcmMonoOut" xPos="612" yPos="503">
			<inputs>
				<val description="Audio input" id="0" value="0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="18" name="modulators/AdsrLinMidi" xPos="196" yPos="290">
			<inputs>
				<val description="Amplitude scale factor" id="0" value="1.0"/>
				<val description="Attack time in seconds" id="1" value="0.07"/>
				<val description="Decay time in seconds" id="2" value="0.2"/>
				<val description="Sustain level" id="3" value="0.6"/>
				<val description="Release time in seconds" id="4" value="0.2"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="19" name="control/MidiCtrlIn" xPos="212" yPos="411">
			<inputs>
				...
				<val description="Maximal value for scaled controller" id="3" value="15000.0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="20" name="maths/ControlMultiply" xPos="322" yPos="290">
			<inputs>
				<val description="First control signal" id="0" value="1.0"/>
				<val description="Second control signal" id="1" value="1.0"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="21" name="modulators/AdsrLinMidi" xPos="431" yPos="362">
			<inputs>
				<val description="Amplitude scale factor" id="0" value="1.0"/>
				<val description="Attack time in seconds" id="1" value="0.05"/>
				<val description="Decay time in seconds" id="2" value="0.1"/>
				<val description="Sustain level" id="3" value="0.9"/>
				<val description="Release time in seconds" id="4" value="0.2"/>
			</inputs>
		</moduleInstance>
		<moduleInstance id="22" name="effects/AnalogEcho" xPos="614" yPos="377">
			<inputs>
				<val description="Audio input" id="0" value="0"/>
				<val description="Output level" id="1" value="1.0"/>
				<val description="Delay factor" id="2" value="0.944"/>
				<val description="Feedback amount" id="3" value="0.5"/>
				<val description="Reverb amount" id="4" value="0.105"/>
			</inputs>
		</moduleInstance>
	</instancesModules>
	<connections>
		<connection inModule="2" inputNum="0" outModule="1" outputNum="0"/>
		<connection inModule="3" inputNum="1" outModule="4" outputNum="0"/>
		<connection inModule="5" inputNum="0" outModule="3" outputNum="0"/>
		<connection inModule="2" inputNum="1" outModule="5" outputNum="0"/>
		<connection inModule="6" inputNum="0" outModule="2" outputNum="0"/>
		<connection inModule="7" inputNum="0" outModule="2" outputNum="0"/>
		<connection inModule="8" inputNum="0" outModule="1" outputNum="0"/>
		<connection inModule="9" inputNum="0" outModule="1" outputNum="0"/>
		<connection inModule="10" inputNum="0" outModule="6" outputNum="0"/>
		<connection inModule="11" inputNum="0" outModule="7" outputNum="0"/>
		<connection inModule="12" inputNum="0" outModule="8" outputNum="0"/>
		<connection inModule="13" inputNum="0" outModule="10" outputNum="0"/>
		<connection inModule="13" inputNum="2" outModule="11" outputNum="0"/>
		<connection inModule="13" inputNum="6" outModule="12" outputNum="0"/>
		<connection inModule="14" inputNum="0" outModule="13" outputNum="0"/>
		<connection inModule="14" inputNum="1" outModule="15" outputNum="0"/>
		<connection inModule="15" inputNum="0" outModule="9" outputNum="0"/>
		<connection inModule="16" inputNum="0" outModule="14" outputNum="0"/>
		<connection inModule="20" inputNum="0" outModule="18" outputNum="0"/>
		<connection inModule="15" inputNum="1" outModule="20" outputNum="0"/>
		<connection inModule="20" inputNum="1" outModule="19" outputNum="0"/>
		<connection inModule="21" inputNum="0" outModule="1" outputNum="2"/>
		<connection inModule="16" inputNum="1" outModule="21" outputNum="0"/>
		<connection inModule="22" inputNum="0" outModule="16" outputNum="0"/>
		<connection inModule="17" inputNum="0" outModule="22" outputNum="0"/>
	</connections>
	<additionalInfo>
