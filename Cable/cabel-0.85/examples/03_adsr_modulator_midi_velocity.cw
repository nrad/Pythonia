...
opcode AdsrLinMidi, k, iiiii
  ...
  xout kenv
endop
  </opcode></moduleReference></referencesModules><instancesModules><moduleInstance id="1" name="sound sources/SawVco" xPos="187" yPos="25"><inputs><val description="Frequency of oscillator" id="0" value="200.0"/><val description="Shape of wave, sawtooth/triangle/ramp" id="1" value="0.001"/></inputs></moduleInstance><moduleInstance id="2" name="amps mixers/Amp" xPos="319" yPos="24"><inputs><val description="Audio signal" id="0" value="0"/><val description="Gain" id="1" value="25000.0"/></inputs></moduleInstance><moduleInstance id="3" name="input output/PcmMonoOut" xPos="429" yPos="26"><inputs><val description="Audio input" id="0" value="0"/></inputs></moduleInstance><moduleInstance id="4" name="control/MidiNoteIn" xPos="16" yPos="21"><inputs><val description="Scaling of MIDI velocity" id="0" value="20000.0"/><val description="Minimal value for scaled channel aftertouch" id="1" value="0.0"/><val description="Maximal value for scaled channel aftertouch" id="2" value="127.0"/></inputs></moduleInstance><moduleInstance id="5" name="modulators/AdsrLinMidi" xPos="195" yPos="94"><inputs><val description="Amplitude scale factor" id="0" value="1.0"/><val description="Attack time in seconds" id="1" value="0.1"/><val description="Decay time in seconds" id="2" value="0.2"/><val description="Sustain level" id="3" value="0.7"/><val description="Release time in seconds" id="4" value="0.2"/></inputs></moduleInstance></instancesModules><connections><connection inModule="2" inputNum="0" outModule="1" outputNum="0"/><connection inModule="3" inputNum="0" outModule="2" outputNum="0"/><connection inModule="1" inputNum="0" outModule="4" outputNum="0"/><connection inModule="5" inputNum="0" outModule="4" outputNum="2"/><connection inModule="2" inputNum="1" outModule="5" outputNum="0"/></connections><additionalInfo><param name="actualModule" value=""/><param name="lastModuleId" value="5"/></additionalInfo></workspace>